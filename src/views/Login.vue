  ...
  <div class="login-container">
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="form-group agreement-group">
          <label class="agreement-label">
            ...
            我已阅读并同意<a href="#" @click.prevent="showAgreement = true">用户协议</a>
          </label>
        </div>
        
        <button type="submit" class="main-btn">{{ isLoginMode ? '登录' : '注册' }}</button>
      </form>
    ...
    <div v-if="showAgreement" class="agreement-modal">
      <div class="agreement-content">
        ...
        <button @click="showAgreement = false" class="close-btn">我已阅读</button>
      </div>
    </div>
  </div>
</template>
